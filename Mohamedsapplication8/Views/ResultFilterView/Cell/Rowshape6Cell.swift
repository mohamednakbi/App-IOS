...
struct Rowshape6Cell: View {
    var body: some View {
        HStack {
            ZStack(alignment: .leading) {
                Image("img_shape_140x168_4")
                    .resizable()
            ...
            .frame(width: getRelativeWidth(166.0), height: getRelativeHeight(140.0),
                   alignment: .leading)
            VStack(alignment: .leading, spacing: 0) {
                Text(StringConstants.kMsgBridgelandMode2)
                ...
                .frame(width: getRelativeWidth(87.0), height: getRelativeHeight(10.0),
                       alignment: .leading)
                .padding(.top, getRelativeHeight(7.0))
                HStack {
                    Text(StringConstants.kLbl260)
...
/* struct Rowshape6Cell_Previews: PreviewProvider {
