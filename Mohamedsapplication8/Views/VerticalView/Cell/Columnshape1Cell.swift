...
struct Columnshape1Cell: View {
    var body: some View {
        VStack(alignment: .leading, spacing: 0) {
            ZStack(alignment: .center) {
                Image("img_shape_160x144_2")
                    .resizable()
                ...
                VStack(alignment: .trailing, spacing: 0) {
                    ...
                    HStack {
                        ...
                        .frame(width: getRelativeWidth(69.0), height: getRelativeHeight(25.0),
                               alignment: .leading)
                        .background(RoundedCorners(topLeft: 8.0, topRight: 8.0, bottomLeft: 8.0,
                                                   bottomRight: 8.0)
                                .fill(ColorConstants.BlueGray700Af))
            ...
            .frame(width: getRelativeWidth(92.0), height: getRelativeHeight(10.0),
                   alignment: .leading)
...
/* struct Columnshape1Cell_Previews: PreviewProvider {
