...
struct PreferableView: View {
    @StateObject var preferableViewModel = PreferableViewModel()
    ...
    var body: some View {
        NavigationView {
            VStack {
                VStack(alignment: .leading, spacing: 0) {
                    ...
                    ZStack(alignment: .center) {
                        ...
                        VStack {
                            ...
                            Button(action: {
                                preferableViewModel.nextScreen = "PreferableSelectedView"
                            }, label: {
                                HStack(spacing: 0) {
                ...
                Group {
                    NavigationLink(destination: PreferableSelectedView(),
                                   tag: "PreferableSelectedView",
                                   selection: $preferableViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
                }
...
struct PreferableView_Previews: PreviewProvider {
