...
struct AddReviewSuccessView: View {
    @StateObject var addReviewSuccessViewModel =
        AddReviewSuccessViewModel(_isOpen: .constant(false))
    ...
    var body: some View {
        VStack {
            VStack {
                ...
                Text(StringConstants.kMsgSuccessfullySu)
                    .font(FontScheme.kRalewayMedium(size: getRelativeHeight(25.0)))
                    .fontWeight(.medium)
                    .foregroundColor(ColorConstants.BlueGray80001)
                    .minimumScaleFactor(0.5)
                    .multilineTextAlignment(.center)
                    .frame(width: getRelativeWidth(296.0), height: getRelativeHeight(76.0),
                           alignment: .center)
...
struct AddReviewSuccessView_Previews: PreviewProvider {
    static var previews: some View {
        AddReviewSuccessView()
    }
}
