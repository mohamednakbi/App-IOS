...
struct ProductTourThreeView: View {
    @StateObject var productTourThreeViewModel = ProductTourThreeViewModel()
            ...
            VStack {
                VStack(alignment: .leading, spacing: 0) {
                    HStack {
                        ...
                        Spacer()
                        Button(action: {
                            productTourThreeViewModel.nextScreen = "LoginView"
                        }, label: {
                            HStack(spacing: 0) {
                    ...
                    Text(StringConstants.kMsgFindPerfectCh)
                        .font(FontScheme.kRalewayMedium(size: getRelativeHeight(25.0)))
                        .fontWeight(.medium)
                        .foregroundColor(ColorConstants.BlueGray80001)
                        .minimumScaleFactor(0.5)
                        .multilineTextAlignment(.leading)
                        .frame(width: getRelativeWidth(290.0), height: getRelativeHeight(76.0),
                    ...
                    ZStack(alignment: .center) {
                        Image("img_backgroundillustration_520x375_3")
                            .resizable()
                ...
                Group {
                    NavigationLink(destination: LoginView(),
                                   tag: "LoginView",
                                   selection: $productTourThreeViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
                }
...
struct ProductTourThreeView_Previews: PreviewProvider {
    static var previews: some View {
        ProductTourThreeView()
    }
}
