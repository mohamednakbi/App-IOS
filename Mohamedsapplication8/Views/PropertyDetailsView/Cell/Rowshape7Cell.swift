...
struct Rowshape7Cell: View {
    var body: some View {
        ZStack(alignment: .bottom) {
            HStack {
                VStack(alignment: .leading, spacing: 0) {
                    ZStack(alignment: .center) {
                        Image("img_shape_160x144_12")
                            .resizable()
                            ...
                            HStack {
                                ...
                                HStack {
                                    ...
                                    Text(StringConstants.kLblMonth)
                                        .font(FontScheme
                                            .kMontserratMedium(size: getRelativeHeight(6.0)))
                                        .fontWeight(.medium)
                                        .foregroundColor(ColorConstants.Gray100)
                                        .minimumScaleFactor(0.5)
                                        .multilineTextAlignment(.leading)
                ...
                .frame(width: getRelativeWidth(158.0), height: getRelativeHeight(231.0),
                       alignment: .leading)
                ...
                VStack(alignment: .leading, spacing: 0) {
                    ...
                    .frame(width: getRelativeWidth(142.0), height: getRelativeHeight(160.0),
                           alignment: .leading)
                    Text(StringConstants.kLblSkyDandelions2)
                        .font(FontScheme.kRalewayBold(size: getRelativeHeight(12.0)))
                        .fontWeight(.bold)
                        .foregroundColor(ColorConstants.BlueGray80001)
                        .minimumScaleFactor(0.5)
...
/* struct Rowshape7Cell_Previews: PreviewProvider {
