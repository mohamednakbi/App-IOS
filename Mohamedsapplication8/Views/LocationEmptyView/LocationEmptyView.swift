...
struct LocationEmptyView: View {
    @StateObject var locationEmptyViewModel = LocationEmptyViewModel()
            ...
            VStack {
                VStack {
                    ...
                    .frame(width: UIScreen.main.bounds.width, height: getRelativeHeight(718.0),
                           alignment: .center)
                    Button(action: {
                        locationEmptyViewModel.nextScreen = "LocationChooseLocationView"
                    }, label: {
                        HStack(spacing: 0) {
                ...
                Group {
                    NavigationLink(destination: LocationChooseLocationView(),
                                   tag: "LocationChooseLocationView",
                                   selection: $locationEmptyViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
                }
...
struct LocationEmptyView_Previews: PreviewProvider {
