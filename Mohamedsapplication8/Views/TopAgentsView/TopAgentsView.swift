...
struct TopAgentsView: View {
    @StateObject var topAgentsViewModel = TopAgentsViewModel()
    ...
    var body: some View {
        NavigationView {
            VStack {
                ...
                Group {
                    NavigationLink(destination: TopAgentsProfileDetailTabContainerView(),
                                   tag: "TopAgentsProfileDetailTabContainerView",
                                   selection: $topAgentsViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
                }
...
struct TopAgentsView_Previews: PreviewProvider {
