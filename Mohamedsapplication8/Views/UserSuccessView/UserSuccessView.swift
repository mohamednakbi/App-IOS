...
struct UserSuccessView: View {
    @StateObject var userSuccessViewModel = UserSuccessViewModel(_isOpen: .constant(false))
    ...
    var body: some View {
        VStack {
            VStack {
                ...
                Text(StringConstants.kMsgAccountSuccess)
                    .font(FontScheme.kRalewayMedium(size: getRelativeHeight(25.0)))
                    .fontWeight(.medium)
                    .foregroundColor(ColorConstants.BlueGray80001)
                    .minimumScaleFactor(0.5)
                    .multilineTextAlignment(.center)
                    .frame(width: getRelativeWidth(270.0), height: getRelativeHeight(72.0),
                           alignment: .center)
...
struct UserSuccessView_Previews: PreviewProvider {
