...
struct EditSuccessView: View {
    @StateObject var editSuccessViewModel = EditSuccessViewModel(_isOpen: .constant(false))
        ...
        VStack {
            VStack {
                ...
                .background(RoundedCorners(topLeft: 71.0, topRight: 71.0, bottomLeft: 71.0,
                                           bottomRight: 71.0)
                        .fill(ColorConstants.IndigoA40063))
                .padding(.top, getRelativeHeight(22.0))
                .padding(.horizontal, getRelativeWidth(92.0))
                Text(StringConstants.kMsgYourListingJust)
                    .font(FontScheme.kRalewayMedium(size: getRelativeHeight(25.0)))
                    .fontWeight(.medium)
                    .foregroundColor(ColorConstants.BlueGray80001)
                    .minimumScaleFactor(0.5)
                    .multilineTextAlignment(.center)
                    .frame(width: getRelativeWidth(302.0), height: getRelativeHeight(75.0),
                           alignment: .center)
...
struct EditSuccessView_Previews: PreviewProvider {
